*This project has been created as part of the 42 curriculum by \<aakerblo\>, \<dheck\>, \<iboukhss\>, \<jmeli\>*
...
In total, 20 points have been implemented.
...
| ✅ | Implement real-time features using WebSockets                        | 2 pts | 
...
| ✅ | Advanced search with filters, sorting, pagination                    | 1 pt  |
...
### User Management — 5/10 pts

| Status | Goal | Score |
|---|---|---|
| ✅ | Standard user management and authentication                          | 2 pts |
| ✅ | Remote authentication with OAuth 2.0                                 | 1 pt  |
| ✅ | Advanced permission system                                           | 2 pts |

### Data and Analytics — 2/4 pts
...
For detailed individual contributions to specific features, please refer to the 'Features' section. Overall, every team member actively participated in identifying and fixing bugs. Furthermore, whenever a team member proposed a new feature idea, it was discussed collectively. If the idea was deemed useful and feasible, a corresponding ticket was created and assigned to the proposing member.
